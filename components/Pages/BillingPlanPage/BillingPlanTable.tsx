...
const BillingPlanTable: React.FC = () => {
  ...
  const cards = [
    ...
    { title: 'Essentials', description: 'For small businesses', price:'29', features:['3 chatbots', '500 chat sessions/month', '250MB document storage','3 linked website', 'Tickets', 'Chat logs', 'Email notifications']  },
    { title: 'Advanced', description: 'More of everything', price:'49' , features:['Up to 5 chatbots', '1000 chat sessions/month', '1GB document storage','Up to 7 linked website', 'Tickets', 'Chat logs', 'Email notifications']  },
