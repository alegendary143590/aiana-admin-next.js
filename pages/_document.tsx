...
class MyDocument extends Document {
  ...
  render() {
  const data = this.props.__NEXT_DATA__; // eslint-disable-line no-underscore-dangle

    const currentLocale =
      Array.isArray(data.query.locale)
        ? data.query.locale[0] // Take the first item if it's an array
        : data.query.locale || i18nextConfig.i18n.defaultLocale;
